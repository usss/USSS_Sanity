...
/**
 * SubscriberUpdateBalanceInstanceInputMessage.java
 *
 ...
 */
            ...
            /**
            *  SubscriberUpdateBalanceInstanceInputMessage bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SubscriberUpdateBalanceInstanceInputMessage extends com.comverse.www.AbstractRequestMessage
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = SubscriberUpdateBalanceInstanceInputMessage
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for NewBalances
                        * This was an Array!
                        */

                        
                                    protected com.comverse.www.NamedBalanceInstanceObject[] localNewBalances ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localNewBalancesTracker = false ;

                           public boolean isNewBalancesSpecified(){
                               return localNewBalancesTracker;
                           }
                           ...
                           */
                           public  com.comverse.www.NamedBalanceInstanceObject[] getNewBalances(){
                               return localNewBalances;
                           }
                              ...
                              /**
                               * validate the array for NewBalances
                               */
                              protected void validateNewBalances(com.comverse.www.NamedBalanceInstanceObject[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param NewBalances
                              */
                              public void setNewBalances(com.comverse.www.NamedBalanceInstanceObject[] param){
                              
                                   validateNewBalances(param);

                               localNewBalancesTracker = true;
                                      
                                      this.localNewBalances=param;
                              }
                             ...
                             */
                             public void addNewBalances(com.comverse.www.NamedBalanceInstanceObject param){
                                   if (localNewBalances == null){
                                   localNewBalances = new com.comverse.www.NamedBalanceInstanceObject[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localNewBalances);
                               list.add(param);
                               this.localNewBalances =
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SubscriberUpdateBalanceInstanceInputMessage",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SubscriberUpdateBalanceInstanceInputMessage",
                           xmlWriter);
                   }
                ...
                if (localCustomerVersionTracker){
                              ...
                              if (localSubscriberIdTracker){
                                           ...
                                           localSubscriberId.serialize(new javax.xml.namespace.QName("","subscriberId"),
                                               xmlWriter);
                                        } if (localNewBalancesTracker){
                                       if (localNewBalances!=null){
                                            for (int i = 0;i < localNewBalances.length;i++){
                                                if (localNewBalances[i] != null){
                                                 localNewBalances[i].serialize(new javax.xml.namespace.QName("","newBalances"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "", "newBalances", xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.comverse.com","SubscriberUpdateBalanceInstanceInputMessage"));
                 if (localCustomerVersionTracker){
                             ...
                             if (localNewBalances!=null) {
                                 for (int i = 0;i < localNewBalances.length;i++){
                                    ...
                                    if (localNewBalances[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("",
                                                                          "newBalances"));
                                         elementList.add(localNewBalances[i]);
                                    } else {
                                        ...
                                        elementList.add(new javax.xml.namespace.QName("",
                                                                          "newBalances"));
                                        elementList.add(localNewBalances);
    ...
    public static class Factory{
        ...
        */
        public static SubscriberUpdateBalanceInstanceInputMessage parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SubscriberUpdateBalanceInstanceInputMessage object =
                new SubscriberUpdateBalanceInstanceInputMessage();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SubscriberUpdateBalanceInstanceInputMessage".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SubscriberUpdateBalanceInstanceInputMessage)com.comverse.www.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list26 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","newBalances").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list26.add(com.comverse.www.NamedBalanceInstanceObject.Factory.parse(reader));
                                                                }
                                                        ...
                                                        while(!loopDone26){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("","newBalances").equals(reader.getName())){
                                                        ...
                                                        object.setNewBalances((com.comverse.www.NamedBalanceInstanceObject[])
