...
/**
 * SubscriberAdjustAccumulatorInstanceInputMessage.java
 *
 ...
 */
            ...
            /**
            *  SubscriberAdjustAccumulatorInstanceInputMessage bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SubscriberAdjustAccumulatorInstanceInputMessage extends com.comverse.www.AbstractRequestMessage
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = SubscriberAdjustAccumulatorInstanceInputMessage
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SubscriberAdjustAccumulatorInstanceInputMessage",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SubscriberAdjustAccumulatorInstanceInputMessage",
                           xmlWriter);
                   }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.comverse.com","SubscriberAdjustAccumulatorInstanceInputMessage"));
                 if (localCustomerVersionTracker){
    ...
    public static class Factory{
        ...
        */
        public static SubscriberAdjustAccumulatorInstanceInputMessage parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SubscriberAdjustAccumulatorInstanceInputMessage object =
                new SubscriberAdjustAccumulatorInstanceInputMessage();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SubscriberAdjustAccumulatorInstanceInputMessage".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SubscriberAdjustAccumulatorInstanceInputMessage)com.comverse.www.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
