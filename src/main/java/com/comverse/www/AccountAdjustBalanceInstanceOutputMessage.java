...
/**
 * AccountAdjustBalanceInstanceOutputMessage.java
 *
 ...
 */
            ...
            /**
            *  AccountAdjustBalanceInstanceOutputMessage bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AccountAdjustBalanceInstanceOutputMessage extends com.comverse.www.AbstractResponseMessage
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = AccountAdjustBalanceInstanceOutputMessage
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AccountAdjustBalanceInstanceOutputMessage",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AccountAdjustBalanceInstanceOutputMessage",
                           xmlWriter);
                   }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.comverse.com","AccountAdjustBalanceInstanceOutputMessage"));
                 if (localCustomerVersionTracker){
    ...
    public static class Factory{
        ...
        */
        public static AccountAdjustBalanceInstanceOutputMessage parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AccountAdjustBalanceInstanceOutputMessage object =
                new AccountAdjustBalanceInstanceOutputMessage();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AccountAdjustBalanceInstanceOutputMessage".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AccountAdjustBalanceInstanceOutputMessage)com.comverse.www.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
