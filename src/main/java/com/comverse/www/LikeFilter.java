 ...
 */
            ...
            /**
            *  LikeFilter bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class LikeFilter extends com.comverse.www.BaseFilter
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.comverse.com","likeFilter"));
    ...
    public static class Factory{
        ...
        */
        public static LikeFilter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LikeFilter object =
                new LikeFilter();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"likeFilter".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LikeFilter)com.comverse.www.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
