 ...
 */
            ...
            /**
            *  LessThanFilter bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class LessThanFilter extends com.comverse.www.BaseFilter
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":lessThanFilter",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "lessThanFilter",
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.comverse.com","lessThanFilter"));
                 if (localOrFilterGroupNameTracker){
    ...
    public static class Factory{
        ...
        */
        public static LessThanFilter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LessThanFilter object =
                new LessThanFilter();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"lessThanFilter".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LessThanFilter)com.comverse.www.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
