 ...
 */
            ...
            /**
            *  OrderIdLocator bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class OrderIdLocator
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":orderIdLocator",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "orderIdLocator",
    ...
    public static class Factory{
        ...
        */
        public static OrderIdLocator parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OrderIdLocator object =
                new OrderIdLocator();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"orderIdLocator".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (OrderIdLocator)com.comverse.www.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
