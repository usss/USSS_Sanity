...
/**
 * NrcTermInstanceIdentifier.java
 *
 ...
 */
            ...
            /**
            *  NrcTermInstanceIdentifier bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NrcTermInstanceIdentifier extends com.comverse.www.ObjectBase
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = nrcTermInstanceIdentifier
                ...
                */
                        ...
                        /**
                        * field for NrcTermInstId
                        */

                        
                                    protected com.comverse.www.LongAttributeJAXBElement localNrcTermInstId ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localNrcTermInstIdTracker = false ;

                           public boolean isNrcTermInstIdSpecified(){
                               return localNrcTermInstIdTracker;
                           }
                           ...
                           */
                           public  com.comverse.www.LongAttributeJAXBElement getNrcTermInstId(){
                               return localNrcTermInstId;
                           }
                            ...
                            /**
                               ...
                               * @param param NrcTermInstId
                               */
                               public void setNrcTermInstId(com.comverse.www.LongAttributeJAXBElement param){
                            localNrcTermInstIdTracker = param != null;
                                   
                                            this.localNrcTermInstId=param;
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":nrcTermInstanceIdentifier",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "nrcTermInstanceIdentifier",
                           xmlWriter);
                   }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.comverse.com","nrcTermInstanceIdentifier"));
    ...
    public static class Factory{
        ...
        */
        public static NrcTermInstanceIdentifier parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NrcTermInstanceIdentifier object =
                new NrcTermInstanceIdentifier();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"nrcTermInstanceIdentifier".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NrcTermInstanceIdentifier)com.comverse.www.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
