 ...
 */
            ...
            /**
            *  AccumulatorUpdateObject bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AccumulatorUpdateObject extends com.comverse.www.AccumulatorInstanceObject
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = accumulatorUpdateObject
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.comverse.www.BooleanAttributeJAXBElement localReset ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localResetTracker = false ;

                           public boolean isResetSpecified(){
                               return localResetTracker;
                           }
                           ...
                           */
                           public  com.comverse.www.BooleanAttributeJAXBElement getReset(){
                               return localReset;
                           }
                            ...
                            /**
                               ...
                               * @param param Reset
                               */
                               public void setReset(com.comverse.www.BooleanAttributeJAXBElement param){
                            localResetTracker = param != null;
                                   
                                            this.localReset=param;
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":accumulatorUpdateObject",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "accumulatorUpdateObject",
                           xmlWriter);
                   }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.comverse.com","accumulatorUpdateObject"));
    ...
    public static class Factory{
        ...
        */
        public static AccumulatorUpdateObject parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AccumulatorUpdateObject object =
                new AccumulatorUpdateObject();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"accumulatorUpdateObject".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AccumulatorUpdateObject)com.comverse.www.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
