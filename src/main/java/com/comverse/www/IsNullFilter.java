 ...
 */
            ...
            /**
            *  IsNullFilter bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class IsNullFilter extends com.comverse.www.BaseFilter
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.comverse.com","isNullFilter"));
    ...
    public static class Factory{
        ...
        */
        public static IsNullFilter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IsNullFilter object =
                new IsNullFilter();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"isNullFilter".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (IsNullFilter)com.comverse.www.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
