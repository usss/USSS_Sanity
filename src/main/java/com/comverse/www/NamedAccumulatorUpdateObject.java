...
/**
 * NamedAccumulatorUpdateObject.java
 *
 ...
 */
            ...
            /**
            *  NamedAccumulatorUpdateObject bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NamedAccumulatorUpdateObject extends com.comverse.www.AccumulatorUpdateObject
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = namedAccumulatorUpdateObject
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.comverse.www.StringAttributeJAXBElement localAccumulatorName ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.comverse.www.StringAttributeJAXBElement getAccumulatorName(){
                            ...
                            /**
                               ...
                               */
                               public void setAccumulatorName(com.comverse.www.StringAttributeJAXBElement param){
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":namedAccumulatorUpdateObject",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "namedAccumulatorUpdateObject",
                           xmlWriter);
                   }
                                     ...
                                     localPeriod.serialize(new javax.xml.namespace.QName("","period"),
                                        xmlWriter);
                                           ...
                                           localZeroDay.serialize(new javax.xml.namespace.QName("","zeroDay"),
                                               xmlWriter);
                                        } if (localResetTracker){
                                            if (localReset==null){
                                                 throw new org.apache.axis2.databinding.ADBException("reset cannot be null!!");
                                            }
                                           localReset.serialize(new javax.xml.namespace.QName("","reset"),
                                               xmlWriter);
                                           ...
                                           localAccumulatorName.serialize(new javax.xml.namespace.QName("","accumulatorName"),
                                               xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.comverse.com","namedAccumulatorUpdateObject"));
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localAccumulatorName);
                                }
    ...
    public static class Factory{
        ...
        */
        public static NamedAccumulatorUpdateObject parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NamedAccumulatorUpdateObject object =
                new NamedAccumulatorUpdateObject();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"namedAccumulatorUpdateObject".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NamedAccumulatorUpdateObject)com.comverse.www.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","reset").equals(reader.getName())){
                                
                                                object.setReset(com.comverse.www.BooleanAttributeJAXBElement.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","accumulatorName").equals(reader.getName())){
                                                ...
                                                object.setAccumulatorName(com.comverse.www.StringAttributeJAXBElement.Factory.parse(reader));
