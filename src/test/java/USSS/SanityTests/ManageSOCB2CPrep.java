...
public class ManageSOCB2CPrep {
    ...
    @Steps
    ManageSocB2CPrepSteps B2CSteps;

    @Test
    public void check_enabled_soc_b2c_prep() throws IOException, SQLException, ClassNotFoundException {
        Map<String,String> settings = SettingsTests.getParametersForTest("check_enabled_soc_b2c_prep");
    ...
    @Test
    public void check_disabled_soc_b2c_prep() throws IOException, SQLException, ClassNotFoundException {
        Map<String,String> settings = SettingsTests.getParametersForTest("check_disabled_soc_b2c_prep");
