...
import USSS.steps.B2CPostpaidSteps.ManageServicesSteps;
...
@Story(USSS_6_0_Sanity.B2CPostpaid.ManageServices.class)
public class ManageServicesTest {
    ...
    @Test
    public void check_enabled_service_b2c_post() throws IOException, SQLException, ClassNotFoundException {
        Map<String,String> settings = SettingsTests.getParametersForTest("check_enabled_service_b2c_post");
    ...
    @Test
    public void check_disabled_service_b2c_post() throws IOException, SQLException, ClassNotFoundException {
        Map<String,String> settings = SettingsTests.getParametersForTest("check_disabled_service_b2c_post");
